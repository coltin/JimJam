 ...
 * TRICKY!
 *
 * JobManager can be used to manage various kinds of {@link Job}'s that you will create. These Jobs are discrete units
 * of work that may take a lot of time to process. If the Android system kills your app, it crashes, or the phone
 * reboots, the JobManager can be configured to persist these jobs to disk before they are started. Persisted Jobs will
 * be restarted once your app starts the JobManager.
 *
